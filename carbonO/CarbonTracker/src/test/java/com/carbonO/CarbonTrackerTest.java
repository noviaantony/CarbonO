...
//        headers.set("Authorization", "Bearer JWT TOKEN HERE");
        ...
        ResponseEntity<List<UserCarbonTracker>> result = restTemplate.exchange(uri, HttpMethod.GET, requestEntity,
                new ParameterizedTypeReference<List<UserCarbonTracker>>() {
                });
