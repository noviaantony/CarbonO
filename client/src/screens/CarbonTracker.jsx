          ...
          <form className="m-10 mx-50">
            ...
            <div className="relative ">
              ...
              <div className="flex flex-row">
                ...
                />
                  <button className="ml-4 inline-flex items-center py-2 px-3 text-xs font-xs text-center text-white bg-[#5E9387] rounded-lg  focus:outline-none transition duration-300 mr-3 font-semibold hover:bg-gray-700 hover:text-white"
                          type="button"
                          onClick={() => setshowReceiptUpload(false)}>
                      <MdQrCodeScanner
                          size={50}
